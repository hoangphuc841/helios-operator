...
- `deploy.yaml` - Generated by `make build-installer`
- `config/default/kustomization.yaml` (if auto-generated)
- Files in `bin/` and `dist/`

**Always edit source files in:**

- `api/v1/` - API definitions
- `internal/controller/` - Controller logic
- `config/` subdirectories - Kubernetes manifests
