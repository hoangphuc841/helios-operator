...
graph TB
    ...
    subgraph "Applications"
        HeliosApp1[HeliosApp 1]
        HeliosApp2[HeliosApp 2]
        HeliosApp3[HeliosApp N...]
    end
    ...
    style HeliosApp1 fill:#ffcdd2
    style HeliosApp2 fill:#ffcdd2
    style HeliosApp3 fill:#ffcdd2
```
...
- [HeliosApp Status Conditions](03-helios-app-spec.md#status-conditions)
