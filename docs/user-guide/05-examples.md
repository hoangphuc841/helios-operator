...
```mermaid
graph TD
    subgraph "Example Complexity Levels"
        Basic[Basic Examples<br/>Simple configurations]
        Intermediate[Intermediate Examples<br/>Custom pipelines & resources]
        Advanced[Advanced Examples<br/>Multi-environment & HA]
        RealWorld[Real-World Scenarios<br/>Production deployments]
    end
    ...
    style Microservices fill:#e3f2fd
...
- **Monitoring**: Set up [Monitoring and Observability](06-monitoring.md)
- **Troubleshooting**: Check the [Troubleshooting Guide](04-troubleshooting.md)
- **API Reference**: Review the [HeliosApp Spec Reference](03-helios-app-spec.md)
